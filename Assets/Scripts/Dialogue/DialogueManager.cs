...
public class DialogueManager : MonoBehaviour
{
    ...
    private void DisplayChoices()
    {
        ...
        // defensive check to make sure our UI can support the number of chices coming in
        ...
        int index = 0;
        // enable and initialize the choices up to the amount of choices for this line dialogue
